# 📦 AGENTLINK GitHub Structure - File Index
...
### 1. Download
Files are already in `/mnt/user-data/outputs/AGENTLINK-github/`
...
### 3. Quick Setup
```bash
# Copy to your AGENTLINK directory
cp -r AGENTLINK-github/* /path/to/your/AGENTLINK/
...
1. **Username/Email**
   ...
   - Search for `AGENTLINK.io` and update
